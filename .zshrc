...
# Export variable
export DEVELOPMENT="${HOME}/projects/src"
...
alias pm22='cd $DEVELOPMENT && pm2 start projects.json'
alias pm23='cd $DEVELOPMENT && pm2 start projects.json && sudo timeout 3 sleep 5 || pm2 log'
alias pm2l='pm2 log'
alias pm2s='pm2 status'
alias pm2r='pm2 reload'
alias pm2ra='pm2 reload all'
...
#[[ ! -f /tmp/zsh/theme.zsh ]] || source /tmp/zsh/theme.zsh
